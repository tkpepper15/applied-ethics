        ...
        <section className="max-w-3xl mx-auto">
          ...
          <div className="mx-auto">
            ...
            <p className="text-center text-charcoal-100 mb-10 sm:mb-12 text-sm sm:text-base max-w-2xl mx-auto">
              Built by <a className="hover:text-azure-300 transition-colors border-b border-azure-100" href="https://www.linkedin.com/in/tejjas-kaul-36091a22b/" target="_blank" rel="noopener noreferrer">Tejjas Kaul</a> as part of the NC School of Science & Math&apos;s <a className="hover:text-azure-300 transition-colors border-b border-azure-100" href="https://research-innovation.ncssm.edu/summer-ri-program#h.m0ynxe9icdfe" target="_blank" rel="noopener noreferrer">Summer Research Initiative</a> as well as Duke&apos;s <a className="hover:text-azure-300 transition-colors border-b border-azure-100" href="https://scienceandsociety.duke.edu/how-mission-orientations-ethical-beliefs-and-ownership-structures-have-shaped-the-growth-of-companies-and-their-impacts-on-the-world/" target="_blank" rel="noopener noreferrer">Applied Ethics+ Summer Program</a>. Presented at <a className="hover:text-azure-300 transition-colors border-b border-azure-100" href="https://sncurcs.org/" target="_blank" rel="noopener noreferrer">SNCURCS</a> and NCSSM Alumni Weekend 2024.
            </p>
          </div>
